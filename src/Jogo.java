	...
	static Scanner sc = new Scanner(System.in);
		...
		static void historiaTerceiroDesafio() {
			...
			System.out.println(
					"-------------------------------------------------------------------------------------------- \n\n");
			System.out.println(
					"Depois de um semestre conturbado, a tão esperadaa férias chega. E Ana Clara volta para seu lar para reencontrar seus pais, e falar como tinha sido\n");
			System.out.println("aquela experiência de morar fora e estudar a matéria que era sua paixão. \n");
			System.out.println("Chegando em casa, todos a esperam com uma imensa saudade, Ana Clara se emociona em ver seus pais depois de tanto tempo distante.\n");
			System.out.println("Após as saudações, ela explica como tinha sido difícil viver aqueles dias de solidão e tormentos de seus colegas de classe, mas ela fala que após um deles\n");
			...
			System.out.println("a ajuda dela, chegado lá ela percebeu que tudo estava um caos. O estoque de comida estava tudo errado, seus pais não estavam sabendo racionalizar de forma\n");
		...
		static boolean terceiroDesafio() {
			...
			System.out.println(
					"Tem 3 sacos de 100kg de ração para patos, que tambem pode ser usado para alimentar as galinhas. Os patos comem em média 2kg de ração por dia\n"
